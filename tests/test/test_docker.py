...
back_img_path = r"C:\Users\hanne\Documents\Projekte Offline PC\DHM as a QPI method\rawdata\DHM_Developed\lens_background.tif"
...
#                         save_data=True, save_path=eval_path_img, save_name=f"data_test_docker_{0}",
