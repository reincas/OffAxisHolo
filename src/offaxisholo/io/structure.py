...
"""
Container for the structure_dhm and the experiment.
ToDo: Define the necessary parameters of a Container!
-> Absprache mit reinhard
"""

# ToDo: properties für Structure container weiter bearbeiten!
...
class StructureContainer(Container):
    ...
    def __pre_init__(self):
        ...
        if (self.kwargs["file"] is not None) or (self.kwargs["uuid"] is not None):
            return
        ...
        meta["general description"] = (
            "Collected Information of a 2PP printed structure. Used for easy handling \
         of all information of the structure. DHM as well as Camera images are saved."
        )
